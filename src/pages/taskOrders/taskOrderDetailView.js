...
import {
  ...
  table,
  tooltipContent,
} from '../../bento/taskOrderDetailData';
import {
  singleCheckBox, setSideBarToLoading, setDashboardTableLoading,
} from '../dashboardTab/store/dashboardReducer';
import Widget from '../../components/Widgets/WidgetView';
import PropertySubsection from '../../components/PropertySubsection/taskOrderDetailSubsection';
import NumberOfThings from '../../components/NumberOfThings';
import Snackbar from '../../components/Snackbar';
import colors from '../../utils/colors';

// Main case detail component
const TaskOrderDetail = ({ data, classes }) => {
  ...
  const redirectTo = () => {
    ...
    singleCheckBox([{
      ...
      groupName: 'Task Orders',
      isChecked: true,
      name: data.task_order_info,
  ...
  const stat = {
    numberOfPrograms: 1,
    numberOfTaskOrders: data.num_task_orders,
    numberOfProjects: data.to_num_projects,
    numberOfFiles: data.to_num_files,
  };
    ...
    <>
      ...
      <div className={classes.container}>
        <div className={classes.innerContainer}>
          ...
          <div id="table_project_detail" className={classes.tableContainer}>
...
export default withStyles(styles, { withTheme: true })(TaskOrderDetail);
